...
namespace GIBS.Modules.GIBS_FBFoodOrder.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "GIBS.Modules.GIBS_FBFoodOrder.Data.SqlDataprovider,GIBS_FBFoodOrder";
        ...
        public abstract IDataReader GetOrderList(int visitID, int clientID);

        public abstract void InsertVisitOrderItem(int visitID, int productID, int quantity);
